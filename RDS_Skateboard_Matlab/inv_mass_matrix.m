...
Minv = autogen_inverse_mass_matrix(...
        params.boardI, params.boardMass, x(3), params.boardHeight,...
        params.bottomLinkI, params.bottomLinkYCoM, params.bottomLinkMass,...
        x(4), params.bottomLinkHeight, params.topLinkI, params.topLinkYCoM,...
        params.topLinkMass, x(5));
